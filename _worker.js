...
// Variables
const rootDomain = "kanaeru.my.id"; // Ganti dengan domain utama kalian
const serviceName = "sinobi"; // Ganti dengan nama workers kalian
const apiKey = "gTepoq5_G70T7J6VGCKpDAthv4XQx_6qQ3bz4i4q"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
